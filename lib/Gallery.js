...
var _imageTabLightbox = require("image-tab-lightbox");

var _imageTabLightbox2 = _interopRequireDefault(_imageTabLightbox);
...
var Gallery = function (_Component) {
  ...
  function Gallery(props) {
    ...
    _this.handleClickThumbnail = _this.handleClickThumbnail.bind(_this);
    return _this;
  }
  ...
  _createClass(Gallery, [{
    ...
    key: "handleClickThumbnail",
    value: function handleClickThumbnail(index, event, item) {
      this.setState({ activedId: index });
      if (!this.props.onClickThumbnail && this.props.enableLightbox && !this.props.isVideo) {
    ...
    key: "getOnClickZoomFn",
    value: function getOnClickZoomFn() {
    ...
    value: function render() {
      ...
      var images = this.state.thumbnails.map(function (item, idx) {
        return _react2.default.createElement(_Image2.default, {
          ...
          item: item,
          index: idx,
          isVideo: _this2.props.isVideo,
          morePosition: _this2.props.morePosition,
          activedId: _this2.state.activedId,
          showDownloadIcon: _this2.props.showDownloadIcon,
          margin: _this2.props.margin,
          height: _this2.props.rowHeight,
          isSelectable: _this2.props.enableImageSelection,
          onClick: _this2.handleClickThumbnail,
          onSelectImage: _this2.onSelectImage,
          onClickMoreDetail: _this2.props.onClickMoreDetail,
          onClickDownload: _this2.props.onClickDownload
          // onClickZoom={this.getOnClickThumbnailFn()}
          , enableLightbox: _this2.props.enableLightbox,
          ...
          moreInfoLabel: _this2.props.moreInfoLabel
        });
      });
      ...
      return _react2.default.createElement(
        ...
        images,
        _react2.default.createElement(_imageTabLightbox2.default, _extends({
...
Gallery.propTypes = {
  images: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    resultItemId: _propTypes2.default.string.isRequired,
  ...
  moreInfoLabel: _propTypes2.default.string,
  onClickThumbnail: _propTypes2.default.func,
  onClickMoreDetail: _propTypes2.default.func,
  onClickDownload: _propTypes2.default.func,
  isVideo: _propTypes2.default.bool,
  showDownloadIcon: _propTypes2.default.bool,
  morePosition: _propTypes2.default.string,
