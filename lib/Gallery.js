    ...
    value: function render() {
      ...
      var images = this.state.thumbnails.map(function (item, idx) {
        return _react2.default.createElement(_Image2.default, {
          ...
          onClickMoreDetail: function onClickMoreDetail(id) {
            return _this2.props.onClickMoreDetail(id);
          },
          onClickDownload: function onClickDownload(id) {
            return _this2.props.onClickDownload(id);
          }
