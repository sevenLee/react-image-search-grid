  ...
  _createClass(Image, [{
    ...
    value: function render() {
      ...
      var makeMediaElement = function makeMediaElement() {
        if (_this2.state.isFirstPlayVideo && _this2.props.isVideo) {
          return _react2.default.createElement("video", _extends({}, videoProps, {
            ...
            style: {
              ...
              //     : "none",
              cursor: "pointer",
              width: _this2.props.item.vwidth,
          ...
          if (ThumbnailImageComponent) {
            return _react2.default.createElement(ThumbnailImageComponent, _extends({}, _this2.props, {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "span",
            null,
            this.props.moreInfoLabel === undefined ? "More Info" : this.props.moreInfoLabel
          )
        ),
        _react2.default.createElement(
          "div",
          ...
          "div",
          {
            ...
            onClick: function onClick(e) {
              ...
              if (_this2.props.onClick) {
                if (_this2.props.isVideo) {
                  console.log("#### this.videoRef.current:", _this2.videoRef.current);
                  _this2.setState({ isFirstPlayVideo: true }, function () {
                ...
                _this2.props.onClick(_this2.props.index, e);
              }
            }
          },
          makeMediaElement()
