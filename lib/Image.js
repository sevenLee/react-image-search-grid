    ...
    value: function render() {
      ...
      var videoProps = {
        ...
        onPause: function onPause() {
          ...
          _this2.setState({ playing: false }, function () {
            ...
            onClick: function onClick(e) {
              if (_this2.props.onClick) {
                if (_this2.props.isVideo) {
                  _this2.setState({ isFirstPlayVideo: true, playing: !_this2.state.playing }, function () {
                ...
                _this2.props.onClick(_this2.props.index, e, _this2.props.item);
              }
            }
          },
          makeMediaElement()
